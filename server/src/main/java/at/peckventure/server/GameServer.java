        ...
        server.addListener(new Listener() {
            ...
            public void received(Connection connection, Object object) {
                ...
                if (object instanceof NetworkPackets.PlayerUpdatePacket) {
                    ...
                    ServerPlayer player = ServerPlayer.findPlayer(packet.uuid);
                    if (player != null) {
                    ...
                    if (playerData.getPlayerX() == 0.0 && playerData.getPlayerY() == 0.0) {
                        players.add(new ServerPlayer(physicsWorld, spawnX, spawnY, packet.uuid, connection));
                        connectPacket.posx = spawnX;
                        connectPacket.posy = spawnY;
                    } else {
                        players.add(new ServerPlayer(physicsWorld, playerData.getPlayerX(), playerData.getPlayerY(),  packet.uuid, connection));
