...
public class RegionFile {
    ...
    private int[] offsets = new int[CHUNKS_PER_REGION * CHUNKS_PER_REGION];
    ...
    public void writeChunk(int localX, int localY, byte[] data) throws IOException {
        ...
        channel.write(buffer, sectorNumber * SECTOR_SIZE);
        ...
        entryBuffer.rewind();
        channel.write(entryBuffer, index * 4);
    }
    ...
    public byte[] readChunk(int localX, int localY) throws IOException {
        ...
        channel.read(buffer, sectorNumber * SECTOR_SIZE);
        buffer.rewind();
